...
namespace Stu\Module\Spacecraft\Action\DeactivateSubspace;
...
final class DeactivateSubspace implements ActionControllerInterface
{
    ...
    public function handle(GameControllerInterface $game): void
    {
        ...
        $this->helper->deactivate(request::indInt('id'), SpacecraftSystemTypeEnum::SYSTEM_SUBSPACE_SCANNER, $game, true);
    }
