...
namespace Stu\Module\Station\Action\DeleteFromAlliance;
...
final class DeleteFromAlliance implements ActionControllerInterface
{
    public const string ACTION_IDENTIFIER = 'B_DELETE_FROM_ALLIANCE';
