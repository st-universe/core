...
final class TholianWebUtil implements TholianWebUtilInterface
{
    ...
    public function releaseAllShips(TholianWebInterface $web): void
    {
        foreach ($web->getCapturedShips() as $target) {
            $this->releaseShipFromWeb($target);
        }
    }
    ...
    private function releaseWebHelperIntern(ShipWrapperInterface $wrapper): void
    {
        ...
        $this->shipSystemManager->deactivate($wrapper, ShipSystemTypeEnum::SYSTEM_THOLIAN_WEB, true);
    }
}
