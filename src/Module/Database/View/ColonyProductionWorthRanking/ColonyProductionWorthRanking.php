...
namespace Stu\Module\Database\View\ColonyProductionWorthRanking;
...
final class ColonyProductionWorthRanking implements ViewControllerInterface
{
    public const string VIEW_IDENTIFIER = 'SHOW_COLONY_PRODUCTION_WORTH';
     ...
     */
    private function getProductionNetWorthPerUser(GameControllerInterface $game): array
    {
        $currentUser = $game->getUser();

        $resultSet = $this->colonyRepository->getColoniesProductionNetWorth();
