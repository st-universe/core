...
final class HandlePirateRound implements MaintenanceHandlerInterface
{
    ...
    public function handle(): void
    {
        ...
        if ($endTime !== null && $this->isWithinLast24Hours($endTime)) {
    ...
    private function isWithinLast24Hours(int $timestamp): bool
    {
    ...
    private function createHistoryEntry(string $text): void
    {
        ...
        $kazonUser = $this->userRepository->find(UserEnum::USER_NPC_KAZON);
