...
namespace Stu\Module\Colony\Action\DeactivateBuildingsResidentials;
...
final class DeactivateBuildingsResidentials implements ActionControllerInterface
{

    public const ACTION_IDENTIFIER = 'B_DEACTIVATE_BEVRELATED';
    ...
    public function handle(GameControllerInterface $game): void
    {
        ...
        $fields = Colfields::getListBy("colonies_id=" . $colonyId . " AND buildings_id>0 AND aktiv=1 AND buildings_id IN (SELECT id FROM stu_buildings WHERE bev_pro>0)");
