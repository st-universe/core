...
namespace Stu\Module\Colony\Action\ActivateBuildingsGood;
...
final class ActivateBuildingsGood implements ActionControllerInterface
{

    public const ACTION_IDENTIFIER = 'B_ACTIVATE_GOODRELATED_USER';
