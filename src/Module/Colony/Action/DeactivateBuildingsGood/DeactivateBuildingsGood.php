...
namespace Stu\Module\Colony\Action\DeactivateBuildingsGood;
...
final class DeactivateBuildingsGood implements ActionControllerInterface
{

    public const ACTION_IDENTIFIER = 'B_DEACTIVATE_GOODRELATED_USER';
    ...
    public function handle(GameControllerInterface $game): void
    {
        ...
        $fields = $this->planetFieldRepository->getCommodityConsumingByColonyAndCommodity($colonyId, $goodId);
