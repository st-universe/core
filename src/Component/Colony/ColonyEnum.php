...
final class ColonyEnum
{
    ...
    public const GOOD_SATISFACTION_CARDASSIAN_PRIMARY = 1004;
    public const GOOD_SATISFACTION_FERENGI_PRIMARY = 1005;
    ...
    public const GOOD_SATISFACTION_CARDASSIAN_SECONDARY = 1604;
    public const GOOD_SATISFACTION_FERENGI_SECONDARY = 1605;
