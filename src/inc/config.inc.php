...
define("DATABASE_TYPE_TRADEPOSTS",3);
define("DATABASE_TYPE_MAP",4);

define('DATABASE_CATEGORY_TRADEPOSTS',3);
define('DATABASE_CATEGORY_STARSYSTEMS',7);

define('DATABASE_TYPE_RUMP',1);
define('DATABASE_TYPE_REGION',3);
...
define('GOOD_SATISFACTION_EMPIRE_PRIMARY',1004);

define('GOOD_SATISFACTION_FED_SECONDARY',1021);
define('GOOD_SATISFACTION_EMPIRE_SECONDARY',1024);
