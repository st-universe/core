...
/**
 * @extends EntityRepository<SpacecraftLog>
 */
final class SpacecraftLogRepository extends EntityRepository implements SpacecraftLogRepositoryInterface
{
    ...
    /** @return array<int, array{0: SpacecraftLog, scanDate: ?int}> */
    private function getOwnProfileRows(User $profileUser): array
    {
        ...
        return array_map(
            fn (SpacecraftLog $log): array => [0 => $log, 'scanDate' => null],
            $logs
        );
    }
    ...
    /**
     * @param array<int, array{0: SpacecraftLog, scanDate: ?int}> $rows
     *
