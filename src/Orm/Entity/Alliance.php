...
class Alliance
{
    ...
    public function getJobsWithFounderPermission(): array
    {
        return array_values(array_filter(
            $this->jobs->toArray(),
            fn (AllianceJob $job): bool => $job->hasPermission(AllianceJobPermissionEnum::FOUNDER->value)
        ));
    }
    ...
    public function getJobsWithSuccessorPermission(): array
    {
        return array_values(array_filter(
            $this->jobs->toArray(),
            fn (AllianceJob $job): bool => $job->hasPermission(AllianceJobPermissionEnum::SUCCESSOR->value)
        ));
    }
    ...
    public function getJobsWithDiplomaticPermission(): array
    {
        return array_values(array_filter(
            $this->jobs->toArray(),
            fn (AllianceJob $job): bool => $job->hasPermission(AllianceJobPermissionEnum::DIPLOMATIC->value)
        ));
    }
