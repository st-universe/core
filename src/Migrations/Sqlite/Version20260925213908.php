 ...
 */
final class Version20260925213908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stu_alliance_settings (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, setting VARCHAR(255) NOT NULL, value VARCHAR(255) NOT NULL, alliance_id INTEGER NOT NULL, CONSTRAINT FK_39FF05F710A0EA3F FOREIGN KEY (alliance_id) REFERENCES stu_alliances (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX IDX_D20755B91485E613 ON stu_buildings_commodity (buildings_id)');
        $this->addSql('CREATE INDEX building_commodity_count_idx ON stu_buildings_commodity (count)');
        ...
        $this->addSql('CREATE TABLE stu_buildplans_hangar (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, rump_id INTEGER NOT NULL, buildplan_id INTEGER NOT NULL, start_energy_costs INTEGER NOT NULL, default_torpedo_type_id INTEGER DEFAULT NULL, CONSTRAINT FK_DE1E0721497D0592 FOREIGN KEY (default_torpedo_type_id) REFERENCES stu_torpedo_types (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DE1E07218638E4E7 FOREIGN KEY (buildplan_id) REFERENCES stu_buildplan (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DE1E07212EE98D4C FOREIGN KEY (rump_id) REFERENCES stu_rump (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX planet_field_field_idx ON stu_colonies_fielddata (field_id)');
        $this->addSql('CREATE INDEX planet_field_aktiv_idx ON stu_colonies_fielddata (aktiv)');
        ...
        $this->addSql('CREATE TABLE stu_colonies_shiprepair (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, colony_id INTEGER NOT NULL, ship_id INTEGER NOT NULL, field_id INTEGER NOT NULL, finish_time INTEGER NOT NULL, stop_date INTEGER NOT NULL, is_stopped BOOLEAN NOT NULL, CONSTRAINT FK_F14F182F96ADBADE FOREIGN KEY (colony_id) REFERENCES stu_colony (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_F14F182FC256317D FOREIGN KEY (ship_id) REFERENCES stu_ship (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_colony_class_restriction (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, terraforming_id INTEGER DEFAULT NULL, building_id INTEGER DEFAULT NULL, colony_class_id INTEGER NOT NULL, CONSTRAINT FK_CEF73D7ABA61CECC FOREIGN KEY (colony_class_id) REFERENCES stu_colonies_classes (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CEF73D7ABD31079C FOREIGN KEY (terraforming_id) REFERENCES stu_terraforming (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CEF73D7A4D2A7E12 FOREIGN KEY (building_id) REFERENCES stu_buildings (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_colony_sandbox (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, colony_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, bev_work INTEGER NOT NULL, bev_max INTEGER NOT NULL, max_eps INTEGER NOT NULL, max_storage INTEGER NOT NULL, mask CLOB DEFAULT NULL, CONSTRAINT FK_7F824EAB96ADBADE FOREIGN KEY (colony_id) REFERENCES stu_colony (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_crew (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type SMALLINT NOT NULL, rank VARCHAR(255) DEFAULT \'CADET\' NOT NULL, is_slave BOOLEAN DEFAULT 0 NOT NULL, gender SMALLINT NOT NULL, name VARCHAR(255) NOT NULL, user_id INTEGER NOT NULL, race_id INTEGER NOT NULL, CONSTRAINT FK_167BE6E46E59D40D FOREIGN KEY (race_id) REFERENCES stu_crew_race (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_167BE6E4A76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_database_categories (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, description VARCHAR(255) NOT NULL, points INTEGER NOT NULL, type INTEGER NOT NULL, sort INTEGER NOT NULL, prestige INTEGER NOT NULL)');
        $this->addSql('CREATE TABLE stu_database_category_awards (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, category_id INTEGER NOT NULL, layer_id INTEGER DEFAULT NULL, award_id INTEGER DEFAULT NULL, CONSTRAINT FK_EEBC1A0512469DE2 FOREIGN KEY (category_id) REFERENCES stu_database_categories (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EEBC1A053D5282CF FOREIGN KEY (award_id) REFERENCES stu_award (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_EEBC1A0512469DE2 ON stu_database_category_awards (category_id)');
        $this->addSql('CREATE INDEX IDX_EEBC1A053D5282CF ON stu_database_category_awards (award_id)');
        ...
        $this->addSql('CREATE INDEX IDX_4D14EE9A12469DE2 ON stu_database_entrys (category_id)');
        ...
        $this->addSql('CREATE INDEX IDX_6DAE42FC4448F8DA ON stu_deals (faction_id)');
        $this->addSql('CREATE TABLE stu_dockingrights (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, target INTEGER NOT NULL, privilege_type SMALLINT NOT NULL, privilege_mode SMALLINT NOT NULL, station_id INTEGER NOT NULL, CONSTRAINT FK_E7D4B2A21BDB235 FOREIGN KEY (station_id) REFERENCES stu_station (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_E7D4B2A21BDB235 ON stu_dockingrights (station_id)');
        ...
        $this->addSql('CREATE TABLE stu_fleets (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(200) NOT NULL, sort INTEGER DEFAULT NULL, is_fixed BOOLEAN NOT NULL, user_id INTEGER NOT NULL, ships_id INTEGER NOT NULL, defended_colony_id INTEGER DEFAULT NULL, blocked_colony_id INTEGER DEFAULT NULL, CONSTRAINT FK_2042261BA76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2042261BC907E695 FOREIGN KEY (ships_id) REFERENCES stu_ship (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2042261BF61193E4 FOREIGN KEY (defended_colony_id) REFERENCES stu_colony (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2042261B9722AC5D FOREIGN KEY (blocked_colony_id) REFERENCES stu_colony (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_history (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, text CLOB NOT NULL, date INTEGER NOT NULL, type SMALLINT NOT NULL, source_user_id INTEGER DEFAULT NULL, target_user_id INTEGER DEFAULT NULL, location_id INTEGER DEFAULT NULL, CONSTRAINT FK_7F01683964D218E FOREIGN KEY (location_id) REFERENCES stu_location (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_7F01683964D218E ON stu_history (location_id)');
        ...
        $this->addSql('CREATE UNIQUE INDEX unique_kn_archiv_former_id_version ON stu_kn_archiv (former_id, version)');
        ...
        $this->addSql('CREATE TABLE stu_kn_comments_archiv (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, version VARCHAR(255) NOT NULL, former_id INTEGER NOT NULL, post_id INTEGER NOT NULL, user_id INTEGER NOT NULL, username VARCHAR(255) NOT NULL, text VARCHAR(255) NOT NULL, date INTEGER NOT NULL, deleted INTEGER DEFAULT NULL)');
        ...
        $this->addSql('CREATE TABLE stu_map_regions (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, description VARCHAR(255) NOT NULL, database_id INTEGER DEFAULT NULL, layers VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_3CCEB5C5F0AA09DB FOREIGN KEY (database_id) REFERENCES stu_database_entrys (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_news (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, subject VARCHAR(255) NOT NULL, text CLOB NOT NULL, date INTEGER NOT NULL, refs CLOB NOT NULL, is_changelog BOOLEAN DEFAULT NULL)');
        ...
        $this->addSql('CREATE TABLE stu_npc_quest_user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, quest_id INTEGER NOT NULL, user_id INTEGER NOT NULL, mode INTEGER NOT NULL, reward_received BOOLEAN DEFAULT 0 NOT NULL, CONSTRAINT FK_54C0581209E9EF4 FOREIGN KEY (quest_id) REFERENCES stu_npc_quests (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_54C0581A76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_pirate_wrath (wrath INTEGER NOT NULL, protection_timeout INTEGER DEFAULT NULL, user_id INTEGER NOT NULL, PRIMARY KEY (user_id), CONSTRAINT FK_A7D3C35BA76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX IDX_5C1857F8506FDB14 ON stu_planet_type_research (planet_type_id)');
        ...
        $this->addSql('CREATE INDEX planet_commodity_commodity_idx ON stu_planets_commodity (commodity_id)');
        $this->addSql('CREATE INDEX planet_commodity_count_idx ON stu_planets_commodity (count)');
        $this->addSql('CREATE UNIQUE INDEX planet_commodity_unique_idx ON stu_planets_commodity (planet_classes_id, commodity_id)');
        ...
        $this->addSql('CREATE TABLE stu_plots_members_archiv (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, version VARCHAR(255) NOT NULL, former_id INTEGER NOT NULL, plot_id INTEGER NOT NULL, user_id INTEGER NOT NULL, username VARCHAR(255) DEFAULT NULL)');
        ...
        $this->addSql('CREATE INDEX pm_date_idx ON stu_pms (date)');
        ...
        $this->addSql('CREATE TABLE stu_relation_permissions (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, permission SMALLINT NOT NULL, direction SMALLINT NOT NULL, pending BOOLEAN NOT NULL, granted BOOLEAN NOT NULL, offered_by_source BOOLEAN NOT NULL, relation_id INTEGER DEFAULT NULL, contact_id INTEGER DEFAULT NULL, CONSTRAINT FK_4FB919C33256915B FOREIGN KEY (relation_id) REFERENCES stu_relations (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_4FB919C3E7A1254A FOREIGN KEY (contact_id) REFERENCES stu_contactlist (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX relation_source_alliance_idx ON stu_relations (source_alliance_id)');
        $this->addSql('CREATE INDEX relation_recipient_alliance_idx ON stu_relations (recipient_alliance_id)');
        ...
        $this->addSql('CREATE TABLE stu_rump_base_values (evade_chance SMALLINT NOT NULL, hit_chance SMALLINT NOT NULL, module_level SMALLINT NOT NULL, base_crew SMALLINT NOT NULL, max_crew SMALLINT NOT NULL, base_eps SMALLINT NOT NULL, base_reactor SMALLINT NOT NULL, base_hull INTEGER NOT NULL, base_shield INTEGER NOT NULL, base_damage SMALLINT NOT NULL, base_sensor_range SMALLINT NOT NULL, base_warpdrive INTEGER NOT NULL, special_slots SMALLINT NOT NULL, rump_id INTEGER NOT NULL, PRIMARY KEY (rump_id), CONSTRAINT FK_C47ECAED2EE98D4C FOREIGN KEY (rump_id) REFERENCES stu_rump (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_rumps_cat_role_crew (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, rump_category_id INTEGER NOT NULL, rump_role_id INTEGER NOT NULL, job_1_crew SMALLINT NOT NULL, job_2_crew SMALLINT NOT NULL, job_3_crew SMALLINT NOT NULL, job_4_crew SMALLINT NOT NULL, job_5_crew SMALLINT NOT NULL, job_6_crew SMALLINT NOT NULL, CONSTRAINT FK_976EF6322F027718 FOREIGN KEY (rump_role_id) REFERENCES stu_rumps_roles (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_rumps_categories (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, database_id INTEGER DEFAULT NULL, CONSTRAINT FK_D23A3E0BF0AA09DB FOREIGN KEY (database_id) REFERENCES stu_database_entrys (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_skill_enhancement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type SMALLINT NOT NULL, position SMALLINT NOT NULL, expertise INTEGER NOT NULL, cooldown INTEGER DEFAULT NULL, description VARCHAR(255) NOT NULL)');
        ...
        $this->addSql('CREATE TABLE stu_spacecraft_log (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, spacecraft_id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, rump_id INTEGER DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, text CLOB NOT NULL, date INTEGER NOT NULL, edited INTEGER DEFAULT NULL, is_private BOOLEAN NOT NULL, deleted INTEGER DEFAULT NULL, CONSTRAINT FK_DA27BBBDA76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_station_shiprepair (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, station_id INTEGER NOT NULL, ship_id INTEGER NOT NULL, finish_time INTEGER NOT NULL, stop_date INTEGER NOT NULL, is_stopped BOOLEAN NOT NULL, CONSTRAINT FK_51875AF721BDB235 FOREIGN KEY (station_id) REFERENCES stu_station (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_51875AF7C256317D FOREIGN KEY (ship_id) REFERENCES stu_ship (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_storage (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, commodity_id INTEGER NOT NULL, count INTEGER NOT NULL, colony_id INTEGER DEFAULT NULL, spacecraft_id INTEGER DEFAULT NULL, torpedo_storage_id INTEGER DEFAULT NULL, tradepost_id INTEGER DEFAULT NULL, tradeoffer_id INTEGER DEFAULT NULL, trumfield_id INTEGER DEFAULT NULL, CONSTRAINT FK_CC10346A76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC10346B4ACC212 FOREIGN KEY (commodity_id) REFERENCES stu_commodity (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC1034696ADBADE FOREIGN KEY (colony_id) REFERENCES stu_colony (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC103461C6AF6FD FOREIGN KEY (spacecraft_id) REFERENCES stu_spacecraft (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC1034686DD9CFF FOREIGN KEY (torpedo_storage_id) REFERENCES stu_torpedo_storage (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC103468B935ABD FOREIGN KEY (tradepost_id) REFERENCES stu_trade_posts (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC10346D40ECD65 FOREIGN KEY (tradeoffer_id) REFERENCES stu_trade_offers (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC10346668E6720 FOREIGN KEY (trumfield_id) REFERENCES stu_trumfield (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_trade_posts (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description CLOB NOT NULL, trade_network SMALLINT NOT NULL, level SMALLINT NOT NULL, transfer_capacity INTEGER NOT NULL, storage INTEGER NOT NULL, is_dock_pm_auto_read BOOLEAN DEFAULT NULL, user_id INTEGER NOT NULL, station_id INTEGER NOT NULL, CONSTRAINT FK_13D25E73A76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_13D25E7321BDB235 FOREIGN KEY (station_id) REFERENCES stu_station (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_user_iptable (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, ip VARCHAR(255) NOT NULL, session VARCHAR(255) NOT NULL, agent VARCHAR(255) NOT NULL, start_date DATETIME DEFAULT NULL, end_date DATETIME DEFAULT NULL, CONSTRAINT FK_4DB0B7AAA76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_user_map (cx INTEGER NOT NULL, cy INTEGER NOT NULL, map_id INTEGER NOT NULL, user_id INTEGER NOT NULL, layer_id INTEGER NOT NULL, PRIMARY KEY (cx, cy, user_id, layer_id), CONSTRAINT FK_C6E86038A76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C6E86038EA6EFDCD FOREIGN KEY (layer_id) REFERENCES stu_layer (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_user_pirate_round (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, pirate_round_id INTEGER NOT NULL, destroyed_ships INTEGER NOT NULL, prestige INTEGER NOT NULL, CONSTRAINT FK_3CECD0A8A76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3CECD0A88DA7A3A1 FOREIGN KEY (pirate_round_id) REFERENCES stu_pirate_round (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_3CECD0A8A76ED395 ON stu_user_pirate_round (user_id)');
        $this->addSql('CREATE INDEX IDX_3CECD0A88DA7A3A1 ON stu_user_pirate_round (pirate_round_id)');
        ...
        $this->addSql('CREATE TABLE stu_wormhole_entry (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type VARCHAR(10) NOT NULL, last_used INTEGER DEFAULT NULL, cooldown INTEGER DEFAULT NULL, map_id INTEGER NOT NULL, system_id INTEGER NOT NULL, system_map_id INTEGER NOT NULL, CONSTRAINT FK_D68CF8C953C55F64 FOREIGN KEY (map_id) REFERENCES stu_map (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D68CF8C9D0952FA5 FOREIGN KEY (system_id) REFERENCES stu_systems (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D68CF8C9434BEAA5 FOREIGN KEY (system_map_id) REFERENCES stu_sys_map (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_wormhole_restrictions (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, target INTEGER NOT NULL, privilege_type SMALLINT DEFAULT NULL, mode INTEGER DEFAULT NULL, wormhole_entry_id INTEGER NOT NULL, CONSTRAINT FK_76C7B8E0BE56147A FOREIGN KEY (wormhole_entry_id) REFERENCES stu_wormhole_entry (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE stu_colony');
        $this->addSql('DROP TABLE stu_colony_changeable');
        ...
        $this->addSql('DROP TABLE stu_database_category_awards');
        ...
        $this->addSql('DROP TABLE stu_user_pirate_round');
