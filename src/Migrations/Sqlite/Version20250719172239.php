...
final class Version20250719172239 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE stu_alliance_settings (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, setting VARCHAR(255) NOT NULL, value VARCHAR(255) NOT NULL, alliance_id INTEGER NOT NULL, CONSTRAINT FK_39FF05F710A0EA3F FOREIGN KEY (alliance_id) REFERENCES stu_alliances (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE stu_colonies_shiprepair (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, colony_id INTEGER NOT NULL, ship_id INTEGER NOT NULL, field_id INTEGER NOT NULL, CONSTRAINT FK_F14F182F96ADBADE FOREIGN KEY (colony_id) REFERENCES stu_colony (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_F14F182FC256317D FOREIGN KEY (ship_id) REFERENCES stu_ship (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE stu_colonies_terraforming (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, colonies_id INTEGER NOT NULL, field_id INTEGER NOT NULL, terraforming_id INTEGER NOT NULL, finished INTEGER NOT NULL, CONSTRAINT FK_AFB8ADC7BD31079C FOREIGN KEY (terraforming_id) REFERENCES stu_terraforming (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_AFB8ADC7443707B0 FOREIGN KEY (field_id) REFERENCES stu_colonies_fielddata (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_AFB8ADC774EB5CC8 FOREIGN KEY (colonies_id) REFERENCES stu_colony (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE stu_colony_class_restriction (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, terraforming_id INTEGER DEFAULT NULL, building_id INTEGER DEFAULT NULL, colony_class_id INTEGER NOT NULL, CONSTRAINT FK_CEF73D7ABA61CECC FOREIGN KEY (colony_class_id) REFERENCES stu_colonies_classes (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CEF73D7ABD31079C FOREIGN KEY (terraforming_id) REFERENCES stu_terraforming (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CEF73D7A4D2A7E12 FOREIGN KEY (building_id) REFERENCES stu_buildings (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE stu_colony_deposit_mining (commodity_id INTEGER NOT NULL, amount_left INTEGER NOT NULL, user_id INTEGER NOT NULL, colony_id INTEGER NOT NULL, PRIMARY KEY(user_id, colony_id, commodity_id), CONSTRAINT FK_BD7DF1EAA76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BD7DF1EA96ADBADE FOREIGN KEY (colony_id) REFERENCES stu_colony (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BD7DF1EAB4ACC212 FOREIGN KEY (commodity_id) REFERENCES stu_commodity (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE stu_colony_sandbox (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, colony_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, bev_work INTEGER NOT NULL, bev_max INTEGER NOT NULL, max_eps INTEGER NOT NULL, max_storage INTEGER NOT NULL, mask CLOB DEFAULT NULL, CONSTRAINT FK_7F824EAB96ADBADE FOREIGN KEY (colony_id) REFERENCES stu_colony (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE stu_crew_training (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, colony_id INTEGER NOT NULL, CONSTRAINT FK_E25756B996ADBADE FOREIGN KEY (colony_id) REFERENCES stu_colony (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_E25756B9A76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE stu_deals (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, auction BOOLEAN NOT NULL, amount INTEGER DEFAULT NULL, give_commodity INTEGER DEFAULT NULL, want_commodity INTEGER DEFAULT NULL, give_commodity_amonut INTEGER DEFAULT NULL, want_commodity_amount INTEGER DEFAULT NULL, want_prestige INTEGER DEFAULT NULL, buildplan_id INTEGER DEFAULT NULL, ship BOOLEAN DEFAULT NULL, start INTEGER NOT NULL, "end" INTEGER NOT NULL, taken_time INTEGER DEFAULT NULL, auction_user INTEGER DEFAULT NULL, auction_amount INTEGER DEFAULT NULL, faction_id INTEGER DEFAULT NULL, CONSTRAINT FK_6DAE42FCF27F1BE1 FOREIGN KEY (want_commodity) REFERENCES stu_commodity (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6DAE42FCABA274E9 FOREIGN KEY (give_commodity) REFERENCES stu_commodity (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6DAE42FC8638E4E7 FOREIGN KEY (buildplan_id) REFERENCES stu_buildplan (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6DAE42FC4448F8DA FOREIGN KEY (faction_id) REFERENCES stu_factions (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE stu_kn_comments_archiv (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, version VARCHAR(255) NOT NULL, former_id INTEGER NOT NULL, post_id INTEGER NOT NULL, user_id INTEGER NOT NULL, username VARCHAR(255) NOT NULL, text VARCHAR(255) NOT NULL, date INTEGER NOT NULL, deleted INTEGER DEFAULT NULL)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE stu_map_ftypes (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type INTEGER NOT NULL, is_system BOOLEAN NOT NULL, ecost SMALLINT NOT NULL, name VARCHAR(255) NOT NULL, damage SMALLINT NOT NULL, x_damage SMALLINT NOT NULL, x_damage_system SMALLINT DEFAULT NULL, x_damage_type SMALLINT DEFAULT NULL, "view" BOOLEAN NOT NULL, passable BOOLEAN NOT NULL, complementary_color VARCHAR(255) DEFAULT NULL, effects CLOB DEFAULT NULL, colonies_classes_id INTEGER DEFAULT NULL, CONSTRAINT FK_3D24A6CE9106126 FOREIGN KEY (colonies_classes_id) REFERENCES stu_colonies_classes (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_5C1857F8506FDB14 ON stu_planet_type_research (planet_type_id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE stu_storage (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, commodity_id INTEGER NOT NULL, count INTEGER NOT NULL, colony_id INTEGER DEFAULT NULL, spacecraft_id INTEGER DEFAULT NULL, torpedo_storage_id INTEGER DEFAULT NULL, tradepost_id INTEGER DEFAULT NULL, tradeoffer_id INTEGER DEFAULT NULL, trumfield_id INTEGER DEFAULT NULL, CONSTRAINT FK_CC10346A76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC10346B4ACC212 FOREIGN KEY (commodity_id) REFERENCES stu_commodity (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC1034696ADBADE FOREIGN KEY (colony_id) REFERENCES stu_colony (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC103461C6AF6FD FOREIGN KEY (spacecraft_id) REFERENCES stu_spacecraft (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC1034686DD9CFF FOREIGN KEY (torpedo_storage_id) REFERENCES stu_torpedo_storage (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC103468B935ABD FOREIGN KEY (tradepost_id) REFERENCES stu_trade_posts (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC10346D40ECD65 FOREIGN KEY (tradeoffer_id) REFERENCES stu_trade_offers (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC10346668E6720 FOREIGN KEY (trumfield_id) REFERENCES stu_trumfield (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
