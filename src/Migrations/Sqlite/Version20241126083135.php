...
final class Version20241126083135 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stu_buildplans (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, rump_id INTEGER NOT NULL, user_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, buildtime INTEGER NOT NULL, signature VARCHAR(32) DEFAULT NULL, crew SMALLINT NOT NULL, CONSTRAINT FK_E6E3CB1B2EE98D4C FOREIGN KEY (rump_id) REFERENCES stu_rumps (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_E6E3CB1BA76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_E6E3CB1B2EE98D4C ON stu_buildplans (rump_id)');
        $this->addSql('CREATE INDEX IDX_E6E3CB1BA76ED395 ON stu_buildplans (user_id)');
        $this->addSql('CREATE UNIQUE INDEX buildplan_signatures_idx ON stu_buildplans (user_id, rump_id, signature)');
        $this->addSql('CREATE TABLE stu_buildplans_hangar (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, rump_id INTEGER NOT NULL, buildplan_id INTEGER NOT NULL, default_torpedo_type_id INTEGER DEFAULT NULL, start_energy_costs INTEGER NOT NULL, CONSTRAINT FK_DE1E0721497D0592 FOREIGN KEY (default_torpedo_type_id) REFERENCES stu_torpedo_types (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DE1E07218638E4E7 FOREIGN KEY (buildplan_id) REFERENCES stu_buildplans (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DE1E07212EE98D4C FOREIGN KEY (rump_id) REFERENCES stu_rumps (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_colonies_shipqueue (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, colony_id INTEGER NOT NULL, user_id INTEGER NOT NULL, rump_id INTEGER NOT NULL, buildplan_id INTEGER NOT NULL, buildtime INTEGER NOT NULL, finish_date INTEGER NOT NULL, stop_date INTEGER NOT NULL, building_function_id SMALLINT NOT NULL, mode INTEGER DEFAULT NULL, ship_id INTEGER DEFAULT NULL, CONSTRAINT FK_BEDCCA2F8638E4E7 FOREIGN KEY (buildplan_id) REFERENCES stu_buildplans (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BEDCCA2F2EE98D4C FOREIGN KEY (rump_id) REFERENCES stu_rumps (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BEDCCA2F96ADBADE FOREIGN KEY (colony_id) REFERENCES stu_colonies (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BEDCCA2FC256317D FOREIGN KEY (ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_colonies_shiprepair (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, colony_id INTEGER NOT NULL, ship_id INTEGER NOT NULL, field_id INTEGER NOT NULL, CONSTRAINT FK_F14F182F96ADBADE FOREIGN KEY (colony_id) REFERENCES stu_colonies (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_F14F182FC256317D FOREIGN KEY (ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_construction_progress (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ship_id INTEGER NOT NULL, remaining_ticks INTEGER NOT NULL, CONSTRAINT FK_57D2AD04C256317D FOREIGN KEY (ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_57D2AD04C256317D ON stu_construction_progress (ship_id)');
        $this->addSql('CREATE INDEX construction_progress_ship_idx ON stu_construction_progress (ship_id)');
        ...
        $this->addSql('CREATE TABLE stu_crew_assign (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ship_id INTEGER DEFAULT NULL, colony_id INTEGER DEFAULT NULL, tradepost_id INTEGER DEFAULT NULL, crew_id INTEGER NOT NULL, slot SMALLINT DEFAULT NULL, user_id INTEGER NOT NULL, repair_task_id INTEGER DEFAULT NULL, CONSTRAINT FK_4793ED245FE259F6 FOREIGN KEY (crew_id) REFERENCES stu_crew (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_4793ED24C256317D FOREIGN KEY (ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_4793ED2496ADBADE FOREIGN KEY (colony_id) REFERENCES stu_colonies (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_4793ED248B935ABD FOREIGN KEY (tradepost_id) REFERENCES stu_trade_posts (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_4793ED24A76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_4793ED24130D5415 FOREIGN KEY (repair_task_id) REFERENCES stu_repair_task (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX ship_crew_ship_idx ON stu_crew_assign (ship_id)');
        ...
        $this->addSql('CREATE TABLE stu_deals (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, faction_id INTEGER DEFAULT NULL, auction BOOLEAN NOT NULL, amount INTEGER DEFAULT NULL, give_commodity INTEGER DEFAULT NULL, want_commodity INTEGER DEFAULT NULL, give_commodity_amonut INTEGER DEFAULT NULL, want_commodity_amount INTEGER DEFAULT NULL, want_prestige INTEGER DEFAULT NULL, buildplan_id INTEGER DEFAULT NULL, ship BOOLEAN DEFAULT NULL, start INTEGER NOT NULL, "end" INTEGER NOT NULL, taken_time INTEGER DEFAULT NULL, auction_user INTEGER DEFAULT NULL, auction_amount INTEGER DEFAULT NULL, CONSTRAINT FK_6DAE42FCF27F1BE1 FOREIGN KEY (want_commodity) REFERENCES stu_commodity (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6DAE42FCABA274E9 FOREIGN KEY (give_commodity) REFERENCES stu_commodity (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_6DAE42FC8638E4E7 FOREIGN KEY (buildplan_id) REFERENCES stu_buildplans (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_dockingrights (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ships_id INTEGER NOT NULL, target INTEGER NOT NULL, privilege_type SMALLINT NOT NULL, privilege_mode SMALLINT NOT NULL, CONSTRAINT FK_E7D4B2AC907E695 FOREIGN KEY (ships_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX dockingrights_ship_idx ON stu_dockingrights (ships_id)');
        ...
        $this->addSql('CREATE TABLE stu_lottery_buildplan (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, buildplan_id INTEGER NOT NULL, chance INTEGER NOT NULL, CONSTRAINT FK_E8141D9B8638E4E7 FOREIGN KEY (buildplan_id) REFERENCES stu_buildplans (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_mining_queue (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ship_id INTEGER NOT NULL, location_mining_id INTEGER NOT NULL, CONSTRAINT FK_BBFEF8C427D56C25 FOREIGN KEY (location_mining_id) REFERENCES stu_location_mining (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BBFEF8C4C256317D FOREIGN KEY (ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_pirate_setup_buildplan (pirate_setup_id INTEGER NOT NULL, buildplan_id INTEGER NOT NULL, amount INTEGER NOT NULL, PRIMARY KEY(pirate_setup_id, buildplan_id), CONSTRAINT FK_A99F4154E66A498F FOREIGN KEY (pirate_setup_id) REFERENCES stu_pirate_setup (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A99F41548638E4E7 FOREIGN KEY (buildplan_id) REFERENCES stu_buildplans (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_repair_task (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, ship_id INTEGER NOT NULL, finish_time INTEGER NOT NULL, system_type INTEGER NOT NULL, healing_percentage INTEGER NOT NULL, CONSTRAINT FK_36DA3BAFA76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_36DA3BAFC256317D FOREIGN KEY (ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_36DA3BAFA76ED395 ON stu_repair_task (user_id)');
        $this->addSql('CREATE INDEX IDX_36DA3BAFC256317D ON stu_repair_task (ship_id)');
        $this->addSql('CREATE TABLE stu_research (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description CLOB NOT NULL, sort SMALLINT NOT NULL, rumps_id INTEGER NOT NULL, database_entries CLOB NOT NULL, points SMALLINT NOT NULL, commodity_id INTEGER NOT NULL, reward_buildplan_id INTEGER DEFAULT NULL, award_id INTEGER DEFAULT NULL, needed_award INTEGER DEFAULT NULL, upper_limit_colony_type SMALLINT DEFAULT NULL, upper_limit_colony_amount SMALLINT DEFAULT NULL, CONSTRAINT FK_E9B8FBCAB4ACC212 FOREIGN KEY (commodity_id) REFERENCES stu_commodity (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_E9B8FBCAEEF0C2F2 FOREIGN KEY (reward_buildplan_id) REFERENCES stu_buildplans (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_E9B8FBCA3D5282CF FOREIGN KEY (award_id) REFERENCES stu_award (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX rump_role_idx ON stu_rumps (role_id)');
        ...
        $this->addSql('CREATE TABLE stu_rumps_categories (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, database_id INTEGER DEFAULT NULL, points INTEGER NOT NULL, CONSTRAINT FK_D23A3E0BF0AA09DB FOREIGN KEY (database_id) REFERENCES stu_database_entrys (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_rumps_specials (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, rumps_id INTEGER NOT NULL, special INTEGER NOT NULL, CONSTRAINT FK_3F94D9B298355913 FOREIGN KEY (rumps_id) REFERENCES stu_rumps (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_ship_log (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ship_id INTEGER NOT NULL, text CLOB NOT NULL, date INTEGER NOT NULL, is_private BOOLEAN DEFAULT 0 NOT NULL, deleted INTEGER DEFAULT NULL, CONSTRAINT FK_74CEF0EEC256317D FOREIGN KEY (ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX ship_log_ship_idx ON stu_ship_log (ship_id)');
        $this->addSql('CREATE TABLE stu_ship_system (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ship_id INTEGER NOT NULL, system_type SMALLINT NOT NULL, module_id INTEGER DEFAULT NULL, status SMALLINT NOT NULL, mode SMALLINT NOT NULL, cooldown INTEGER DEFAULT NULL, data CLOB DEFAULT NULL, CONSTRAINT FK_8E777AE9AFC2B591 FOREIGN KEY (module_id) REFERENCES stu_modules (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_8E777AE9C256317D FOREIGN KEY (ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX ship_system_ship_idx ON stu_ship_system (ship_id)');
        $this->addSql('CREATE INDEX ship_system_status_idx ON stu_ship_system (status)');
        $this->addSql('CREATE INDEX ship_system_type_idx ON stu_ship_system (system_type)');
        $this->addSql('CREATE INDEX ship_system_module_idx ON stu_ship_system (module_id)');
        $this->addSql('CREATE INDEX ship_system_mode_idx ON stu_ship_system (mode)');
        $this->addSql('CREATE TABLE stu_ship_takeover (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, source_ship_id INTEGER NOT NULL, target_ship_id INTEGER NOT NULL, start_turn INTEGER NOT NULL, prestige INTEGER NOT NULL, CONSTRAINT FK_4B0B8A7C8B898915 FOREIGN KEY (source_ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_4B0B8A7C93E8816 FOREIGN KEY (target_ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4B0B8A7C8B898915 ON stu_ship_takeover (source_ship_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4B0B8A7C93E8816 ON stu_ship_takeover (target_ship_id)');
        $this->addSql('CREATE INDEX ship_takeover_source_idx ON stu_ship_takeover (source_ship_id)');
        $this->addSql('CREATE INDEX ship_takeover_target_idx ON stu_ship_takeover (target_ship_id)');
        $this->addSql('CREATE TABLE stu_ships (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, rumps_id INTEGER NOT NULL, plans_id INTEGER DEFAULT NULL, fleets_id INTEGER DEFAULT NULL, direction SMALLINT NOT NULL, name VARCHAR(255) NOT NULL, alvl SMALLINT NOT NULL, lss_mode SMALLINT NOT NULL, huelle INTEGER NOT NULL, max_huelle INTEGER NOT NULL, schilde INTEGER NOT NULL, max_schilde INTEGER NOT NULL, tractored_ship_id INTEGER DEFAULT NULL, holding_web_id INTEGER DEFAULT NULL, dock INTEGER DEFAULT NULL, former_rumps_id INTEGER NOT NULL, type SMALLINT NOT NULL, database_id INTEGER DEFAULT NULL, is_destroyed BOOLEAN NOT NULL, disabled BOOLEAN NOT NULL, hit_chance SMALLINT NOT NULL, evade_chance SMALLINT NOT NULL, base_damage SMALLINT NOT NULL, sensor_range SMALLINT NOT NULL, shield_regeneration_timer INTEGER NOT NULL, state SMALLINT NOT NULL, is_fleet_leader BOOLEAN NOT NULL, location_id INTEGER NOT NULL, influence_area_id INTEGER DEFAULT NULL, in_emergency BOOLEAN NOT NULL, CONSTRAINT FK_A560DD56235BF180 FOREIGN KEY (fleets_id) REFERENCES stu_fleets (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A560DD56423BB3E1 FOREIGN KEY (dock) REFERENCES stu_ships (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A560DD56EE54A42E FOREIGN KEY (tractored_ship_id) REFERENCES stu_ships (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A560DD5673D3801E FOREIGN KEY (holding_web_id) REFERENCES stu_tholian_web (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A560DD56A76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A560DD56F0AA09DB FOREIGN KEY (database_id) REFERENCES stu_database_entrys (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A560DD5698355913 FOREIGN KEY (rumps_id) REFERENCES stu_rumps (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A560DD5680446EEB FOREIGN KEY (plans_id) REFERENCES stu_buildplans (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A560DD5664D218E FOREIGN KEY (location_id) REFERENCES stu_location (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A560DD56915ABAF6 FOREIGN KEY (influence_area_id) REFERENCES stu_systems (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_A560DD56423BB3E1 ON stu_ships (dock)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_A560DD56EE54A42E ON stu_ships (tractored_ship_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_A560DD56F0AA09DB ON stu_ships (database_id)');
        $this->addSql('CREATE INDEX IDX_A560DD5680446EEB ON stu_ships (plans_id)');
        $this->addSql('CREATE INDEX ship_fleet_idx ON stu_ships (fleets_id)');
        $this->addSql('CREATE INDEX ship_location_idx ON stu_ships (location_id)');
        $this->addSql('CREATE INDEX ship_rump_idx ON stu_ships (rumps_id)');
        $this->addSql('CREATE INDEX ship_web_idx ON stu_ships (holding_web_id)');
        $this->addSql('CREATE INDEX ship_user_idx ON stu_ships (user_id)');
        $this->addSql('CREATE INDEX ship_tractored_idx ON stu_ships (tractored_ship_id)');
        $this->addSql('CREATE INDEX ship_influence_area_idx ON stu_ships (influence_area_id)');
        $this->addSql('CREATE TABLE stu_shipyard_shipqueue (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ship_id INTEGER NOT NULL, user_id INTEGER NOT NULL, rump_id INTEGER NOT NULL, buildplan_id INTEGER NOT NULL, buildtime INTEGER NOT NULL, finish_date INTEGER NOT NULL, stop_date INTEGER NOT NULL, CONSTRAINT FK_7C6FFB428638E4E7 FOREIGN KEY (buildplan_id) REFERENCES stu_buildplans (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_7C6FFB422EE98D4C FOREIGN KEY (rump_id) REFERENCES stu_rumps (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_7C6FFB42C256317D FOREIGN KEY (ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX IDX_7C6FFB42C256317D ON stu_shipyard_shipqueue (ship_id)');
        ...
        $this->addSql('CREATE TABLE stu_spacecraft_emergency (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ship_id INTEGER NOT NULL, text CLOB NOT NULL, date INTEGER NOT NULL, deleted INTEGER DEFAULT NULL, CONSTRAINT FK_F0230813C256317D FOREIGN KEY (ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX spacecraft_emergency_ship_idx ON stu_spacecraft_emergency (ship_id)');
        $this->addSql('CREATE TABLE stu_station_shiprepair (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, station_id INTEGER NOT NULL, ship_id INTEGER NOT NULL, CONSTRAINT FK_51875AF721BDB235 FOREIGN KEY (station_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_51875AF7C256317D FOREIGN KEY (ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_storage (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, commodity_id INTEGER NOT NULL, count INTEGER NOT NULL, colony_id INTEGER DEFAULT NULL, ship_id INTEGER DEFAULT NULL, torpedo_storage_id INTEGER DEFAULT NULL, tradepost_id INTEGER DEFAULT NULL, tradeoffer_id INTEGER DEFAULT NULL, CONSTRAINT FK_CC10346A76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC10346B4ACC212 FOREIGN KEY (commodity_id) REFERENCES stu_commodity (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC1034696ADBADE FOREIGN KEY (colony_id) REFERENCES stu_colonies (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC10346C256317D FOREIGN KEY (ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC1034686DD9CFF FOREIGN KEY (torpedo_storage_id) REFERENCES stu_torpedo_storage (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC103468B935ABD FOREIGN KEY (tradepost_id) REFERENCES stu_trade_posts (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CC10346D40ECD65 FOREIGN KEY (tradeoffer_id) REFERENCES stu_trade_offers (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX storage_ship_idx ON stu_storage (ship_id)');
        ...
        $this->addSql('CREATE TABLE stu_tholian_web (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, finished_time INTEGER DEFAULT NULL, ship_id INTEGER NOT NULL, CONSTRAINT FK_D032F9A0C256317D FOREIGN KEY (ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE stu_torpedo_storage (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ship_id INTEGER NOT NULL, torpedo_type INTEGER NOT NULL, CONSTRAINT FK_82371911C256317D FOREIGN KEY (ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_82371911942323E3 FOREIGN KEY (torpedo_type) REFERENCES stu_torpedo_types (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_82371911C256317D ON stu_torpedo_storage (ship_id)');
        $this->addSql('CREATE INDEX IDX_82371911942323E3 ON stu_torpedo_storage (torpedo_type)');
        $this->addSql('CREATE INDEX torpedo_storage_ship_idx ON stu_torpedo_storage (ship_id)');
        ...
        $this->addSql('CREATE TABLE stu_trade_posts (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, description CLOB NOT NULL, ship_id INTEGER NOT NULL, trade_network SMALLINT NOT NULL, level SMALLINT NOT NULL, transfer_capacity INTEGER NOT NULL, storage INTEGER NOT NULL, is_dock_pm_auto_read BOOLEAN DEFAULT NULL, CONSTRAINT FK_13D25E73A76ED395 FOREIGN KEY (user_id) REFERENCES stu_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_13D25E73C256317D FOREIGN KEY (ship_id) REFERENCES stu_ships (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_13D25E73A76ED395 ON stu_trade_posts (user_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_13D25E73C256317D ON stu_trade_posts (ship_id)');
        $this->addSql('CREATE INDEX trade_network_idx ON stu_trade_posts (trade_network)');
        $this->addSql('CREATE INDEX trade_post_ship_idx ON stu_trade_posts (ship_id)');
