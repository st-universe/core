...
class starmapapp extends gameapp {
	...
	function editSection() {
		...
		$this->addNavigationPart(new Tuple("starmap.php?SHOW_EDITOR=1","Editor"));
		$this->addNavigationPart(new Tuple("starmap.php?EDIT_SECTION=1&x=".$this->getRequestX()."&y=".$this->getRequestY(),"Sektion editieren"));
		$this->setPageTitle("Sektion editieren");
	}

	protected function showSection() {
		$this->setTemplateFile('html/starmap_section.xhtml');
		$this->addNavigationPart(new Tuple("starmap.php?SHOW_SECTION=1&x=".$this->getRequestX()."&y=".$this->getRequestY(),"Sektion anzeigen"));
	...
	public function getNavigationUp() {
		return array("x" => request::getInt('x'),
	...
	public function getNavigationLeft() {
		return array("x" => request::getInt('x')-1,
			     "y" => request::getInt('y'));
	}
