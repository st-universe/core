...
class AllianceApp extends gameapp {
	...
	function __construct() {
		...
		if ($this->getAllianceId()) {
			$this->addNavigationPart(new Tuple("alliance.php?ALLIANCE_DETAILS=1&id=".$this->getAlliance()->getId(),"Allianzschirm"));
		}
	...
	function showAllianceEdit() {
		if (!$this->getAlliance()->isNew()) {
			...
			$this->addNavigationPart(new Tuple("alliance.php?ALLIANCE_DETAILS=1&id=".$this->getAlliance()->getId(),"Allianz anzeigen"));
			$this->addNavigationPart(new Tuple("alliance.php?EDIT_ALLIANCE=1&id=".$this->getAlliance()->getId(),"Allianz editieren"));
		}
	...
	function showAllianceApplications() {
		...
		$this->setPageTitle("Allianz anzeigen");
		$this->addNavigationPart(new Tuple("alliance.php?ALLIANCE_DETAILS=1&id=".$this->getAlliance()->getId(),"Allianz anzeigen"));
		$this->addNavigationPart(new Tuple("alliance.php?SHOW_APPLICATIONS=1&id=".$this->getAlliance()->getId(),"Bewerbungen"));
	...
	function showAllianceManagement() {
		...
		$this->setPageTitle("Allianz anzeigen");
		$this->addNavigationPart(new Tuple("alliance.php?SHOW_MANAGEMENT=1&id=".$this->getAlliance()->getId(),"Verwaltung"));
	...
	function showRelations() {
		...
		$this->addNavigationPart(new Tuple("alliance.php?SHOW_RELATIONS=1&id=".$this->getAlliance()->getId(),"Diplomatie"));
	...
	function showAllianceBoards() {
		...
		$this->addNavigationPart(new Tuple("alliance.php?SHOW_BOARDS=1&id=".$this->getAlliance()->getId(),"Allianzforum"));
	...
	function showAllianceBoard() {
		...
		$this->setPageTitle("Allianzforum");
		$this->addNavigationPart(new Tuple("alliance.php?SHOW_BOARDS=1&id=".$this->getAlliance()->getId(),"Allianzforum"));
		$this->addNavigationPart(new Tuple("alliance.php?SHOW_BOARD=1&bid=".$this->getBoard()->getId()."&id=".$this->getAlliance()->getId(),$this->getBoard()->getName()));
	...
	function showAllianceTopic() {
		...
		$this->addNavigationPart(new Tuple("alliance.php?SHOW_BOARDS=1&id=".$this->getAlliance()->getId(),"Allianzforum"));
		$this->addNavigationPart(new Tuple("alliance.php?SHOW_BOARD=1&bid=".$this->getBoard()->getId()."&id=".$this->getAlliance()->getId(),$this->getBoard()->getName()));
		$this->addNavigationPart(new Tuple("alliance.php?SHOW_TOPIC=1&bid=".$this->getBoard()->getId()."&tid=".$this->getTopic()->getId()."&id=".$this->getAlliance()->getId(),$this->getTopic()->getName()));
	...
	function showAllianceNewTopic() {
		...
		$this->addNavigationPart(new Tuple("alliance.php?SHOW_BOARDS=1&id=".$this->getAlliance()->getId(),"Allianzforum"));
		$this->addNavigationPart(new Tuple("alliance.php?SHOW_BOARD=1&bid=".$this->getBoard()->getId()."&id=".$this->getAlliance()->getId(),$this->getBoard()->getName()));
		$this->addNavigationPart(new Tuple("alliance.php?SHOW_NEW_TOPIC=1&bid=".$this->getBoard()->getId()."&id=".$this->getAlliance()->getId(),"Thema erstellen"));
	...
	function showAllianceNewPost() {
		...
		$this->addNavigationPart(new Tuple("alliance.php?SHOW_BOARDS=1&id=".$this->getAlliance()->getId(),"Allianzforum"));
		$this->addNavigationPart(new Tuple("alliance.php?SHOW_BOARD=1&bid=".$this->getBoard()->getId()."&id=".$this->getAlliance()->getId(),$this->getBoard()->getName()));
		$this->addNavigationPart(new Tuple("alliance.php?SHOW_NEW_POST=1&bid=".$this->getBoard()->getId()."&id=".$this->getAlliance()->getId(),"Antwort erstellen"));
		$this->setTemplateFile('html/allianceboardcreatetopic.xhtml');
	}
	...
	protected function newRelation() {
		...
		if ($type == ALLIANCE_RELATION_WAR) {
			...
			HistoryEntry::addAllianceEntry("Die Allianz ".$this->getAlliance()->getName()." hat der Allianz ".$opp->getName()." den Krieg erklärt",currentUser()->getId());
	...
	function acceptOffer() {
		...
		$this->sendMessageToOpponent($relation,$text);
		HistoryEntry::addAllianceEntry("Die Allianzen ".$relation->getAlliance()->getName()." und ".$relation->getOpponent()->getName()." sind ein ".$relation->getTypeDescription()." eingegangen",currentUser()->getId());
	...
	function cancelContract() {
		...
		$this->sendMessageToOpponent($relation,$text);
		HistoryEntry::addAllianceEntry("Das ".$relation->getTypeDescription()." zwischen den Allianzen ".$relation->getAlliance()->getName()." und ".$relation->getOpponent()->getName()." wurde aufgelöst",currentUser()->getId());
	...
	public function getTopicNavigation() { #{{{
		if ($this->topic_nav === NULL) {
			...
			for ($i=$curpage-1;$i<=$curpage+3;$i++) {
				...
				$ret[] = array("page" => $i,"mark" => ($i*ALLIANCEBOARDLIMITER-ALLIANCEBOARDLIMITER),"cssclass" => ($curpage+1 == $i ? "pages selected" : "pages"));
			}
			if ($curpage+1 != $maxpage) {
				$ret[] = array("page" => ">","mark" => ($mark+ALLIANCEBOARDLIMITER),"cssclass" => "pages");
				$ret[] = array("page" => ">>","mark" => $maxpage*ALLIANCEBOARDLIMITER-ALLIANCEBOARDLIMITER,"cssclass" => "pages");
			}
			$this->topic_nav = &$ret;
		}
