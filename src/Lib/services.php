...
use Stu\Lib\Transfer\Strategy\TransferStrategyProvider;
...
return [
    ...
    TransferStrategyProviderInterface::class => autowire(TransferStrategyProvider::class)
        ->constructorParameter('transferStrategies', [
