...
final class VersionTestUser extends AbstractMigration
{
    ...
    {
        $this->addSql('INSERT INTO stu_user (id, username, allys_id, faction_id, lastaction_timestamp, kn_lez, vac_active, description, sessiondata, vac_request_date, state, prestige, deals, last_boarding)
