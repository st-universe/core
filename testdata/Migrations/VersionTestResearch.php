...
final class VersionTestResearch extends AbstractMigration
{
    ...
    {
        $this->addSql('INSERT INTO stu_research (id, name, description, sort, rumps_id, database_entries, points, commodity_id, reward_buildplan_id, needed_award, award_id, upper_limit_colony_type, upper_limit_colony_amount)
                VALUES (1001, \'Basisforschung Föderation\', \'Grundforschung der Föderation um weitere Forschungen zu beginnen\', 1, 0, \'{}\', 0, 1701, NULL, NULL, NULL, 1, 1),
                       (42, \'Testforschung\',\'Wissen ist Macht.\',2,0,\'{}\',0,2,NULL,NULL,NULL,0,0)
