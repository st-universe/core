...
final class VersionTestBuildplansModules extends AbstractMigration
{
    ...
    {
        return 'Adds test build plan modules.';
    }

    public function up(Schema $schema): void
    {
        $this->addSql(
            'INSERT INTO stu_buildplans_modules (id, buildplan_id, module_type, module_id, module_special, module_count)
            VALUES 
            (25356, 2324, 1, 10102, NULL, 1),
