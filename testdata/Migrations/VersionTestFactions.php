    ...
    public function up(Schema $schema): void
    {
        $this->addSql(
            ...
            VALUES  (9, \'Fraktionslos\', \'nö\', \'#006400\', false, 0, 0, NULL, 15007, NULL, NULL, NULL),
                    (6, \'Pakled\', \'Sucher...\', \'#5c2e00\', false, 0, 0, NULL, 15007, 100, NULL, NULL),
                    (8, \'Borg-Kollektiv\', \'Alkoven\', \'#006400\', false, 0, 0, NULL, 15007, 200, NULL, NULL),
                    (1, \'Vereinte Föderation der Planeten\', \'Die Föderation ist in STU die vielseitigste Fraktion. 
                        ...
                        Der Schwerpunkt liegt auf der Forschung, aber Föderationssiedler können sich auch im Kampf behaupten.\', \'#0d2029\', true, 50, 82010100, 1001, 15007, 100, 1001, 1601),
                    (2, \'Romulanisches Imperium\', \'Romulaner gelten allgemein als hinterhältig und verschlagen - ein Ruf, den sie auch in der Cragganmore Verwerfung eifrig pflegen.
                        ...
                        Darüber hinaus sind die Romulaner die einzige Rasse, die die hochwertigsten Torpedowerfer benutzen kann.\', \'#0d2000\', true, 50, 82010200, 1002, 15007, 127, 1002, 1602),
                    (7, \'Kazon\', \'Wasser, ich will Wasser\', \'#8B5A2B\', false, 0, 0, NULL, 15007, 200, NULL, NULL),
                    (3, \'Klingonisches Imperium\', \'Die Klingonen sind ein kriegerisches Volk aus dem Betaquadranten.
                        Wer dieses Volk spielt, verfügt über eine Auswahl an effektiven Kampfschiffen und kann Tarnvorrichtungen benutzen.\', \'#2f0300\', true, 50, 82010300, 1002, 15007, 182, 1003, 1603),
                    (4, \'Cardassianische Union\', \'Schon wieder eine Station weniger :-(\', \'#402e00\', true, 50, 82010400, 1002, 15007, 145, 1004, 1604),
                    (5, \'Ferengi Allianz\', \'Die Ferengi sind eine Kultur skrupelloser Kapitalisten, die selbst ihre eigene Großmutter verkaufen würden, wenn sie Latinum dafür bekämen.
                        In STU haben sie Schiffe mit hoher Ladekapazität und können Tachyonscanner einsetzen, um getarnte Schiffe aufzuspüren.\', \'#402100\', true, 50, 82010500, 1002, 15007, 73, 1005, 1605);
            '
        );
    }
}
