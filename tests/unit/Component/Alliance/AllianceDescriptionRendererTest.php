...
class AllianceDescriptionRendererTest extends StuTestCase
{
    ...
    public function testRenderReplacesHomepage(): void
    {
        ...
        $this->alliance->shouldReceive('getHomepage')->withNoArgs()->once()->andReturn($homepage);
    ...
    public function testRenderReplacesBannerWithAvater(): void
    {
        ...
        $this->alliance->shouldReceive('getAvatar')->withNoArgs()->once()->andReturn($avatar);

        $this->config->shouldReceive('get')->with('game.alliance_avatar_path')->once()->andReturn($base_path);
    ...
    public function testRenderReplacesPresidentsName(): void
    {
        ...
        $this->alliance
            ->shouldReceive('getFounder->getUser->getName')
            ->withNoArgs()
            ->once()
            ->andReturn($name);
    ...
    public function testRenderReplacesVicePresidentsName(): void
    {
        ...
        $this->alliance
            ->shouldReceive('getSuccessor->getUser->getName')
            ->withNoArgs()
            ->once()
            ->andReturn($name);
    ...
    {
        $this->alliance->shouldReceive('getSuccessor')->withNoArgs()->once()->andReturnNull();
    ...
    public function testRenderReplacesForeignMinistersName(): void
    {
        ...
        $this->alliance
            ->shouldReceive('getDiplomatic->getUser->getName')
            ->withNoArgs()
            ->once()
            ->andReturn($name);
    ...
    {
        $this->alliance->shouldReceive('getDiplomatic')->withNoArgs()->once()->andReturnNull();
    ...
    {
        $this->alliance->shouldReceive('getAvatar')->withNoArgs()->once()->andReturn('');
    ...
    public function testRenderReplacesDiplomaticRelations(): void
    {
        ...
        $this->alliance->shouldReceive('getId')->withNoArgs()->once()->andReturn($allianceId);

        $this->allianceRelationRepository
            ->shouldReceive('getActiveByAlliance')
            ->with($allianceId)
            ->once()
            ->andReturn([$relation]);
    ...
    private function createRendererExpectations(
        ...
        $parser->shouldReceive('getAsHTML')->withNoArgs()->once()->andReturn($parsedDescription);
