...
class UserProfileProviderTest extends StuTestCase
{
    ...
    private MockInterface&ShipLogRepositoryInterface $shipLogRepository;
    ...
    protected function setUp(): void
    {
        ...
        $this->shipLogRepository = $this->mock(ShipLogRepositoryInterface::class);
    ...
    public function testHandleRenders(): void
    {
        ...
        $this->shipLogRepository->shouldReceive('getGroupedLogbooksForProfile')
            ->with($player, $visitor)
            ->once()
            ->andReturn([]);
